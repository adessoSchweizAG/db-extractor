...
it('fetch driver classes', async () => {
	...
	expect(fetch.mock.calls[0]).toEqual(['http://localhost/rest/driverClassNames', {
...
it('test connection', async () => {
	...
	expect(fetch.mock.calls[1]).toEqual(['http://localhost/rest/dataSourceConfig/dummy/test', {
			headers: { Accept: 'application/json', 'Content-Type': 'application/json' },
			method: 'POST',
